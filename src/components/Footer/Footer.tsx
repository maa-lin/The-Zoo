...
export const Footer = () => {
    ...
    return <footer className={styles.footer}>
        <div className={styles["footer__list-container"]}>
            <span className={styles.footer__title}><span className={styles["footer__title--unskewd"]}>Allt om oss</span></span>
            <ul>
        ...
        <div className={`${styles["footer__list-container"]} ${styles["footer__list-container--socialmedia"]}`}>
            <span className={styles.footer__title}><span className={styles["footer__title--unskewd"]}>Följ oss på sociala medier</span></span>
            <ul>
